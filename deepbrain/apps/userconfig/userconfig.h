...
/******************************************************************
//è®¾å¤‡ä¿¡æ¯ï¼ŒåŒ…æ‹¬åºåˆ—å·å‰ç¼€ã€ç‰ˆæœ¬å·ã€è´¦å·ç­‰
*******************************************************************/
#define PLATFORM_NAME		"RDA5981"
#define DEVICE_SN_PREFIX	"YIYU"

/*
ĞŞ¸ÄÒ»ÏÂ ESP32_FW_VERSION ²¢±£³Ö¸Ãversion Óë version.txtÖĞµÄ version ÏàÍ¬
ÔÚ½«Éú³ÉµÄmain_ota_1001_upgrade.bin(×¢ÒâĞŞ¸Äota3_ota_12.batÖĞµÄ°æ±¾ºÅ)ºÍĞÂµÄversion.txtÔÚ·şÎñÆ÷ÉÏ¸üĞÂÏÂ

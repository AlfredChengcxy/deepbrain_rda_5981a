...
#elif KMT_PCBA
static duer::YTGpadcKey s_button4(/*KEY_B5*/KEY_B3);// long (wechat)			short (play wechat)			4∫≈º¸
...
static duer::YTGpadcKey s_button1(/*KEY_B0*/KEY_B0);// long (awake)			short (net)					1∫≈º¸
#endif

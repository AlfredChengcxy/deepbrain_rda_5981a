...
#elif KMT_PCBA
static duer::YTGpadcKey s_button4(/*KEY_B5*/KEY_B2);// long (wechat)short (play wechat)	---->Œ¢¡ƒ + “Ù¡ø		
static duer::YTGpadcKey s_button3(/*KEY_B4*//*KEY_B2*/KEY_B1);// long (action)short (volume ctl)    ----->µÁª˙+ ≈‰Õ¯
static duer::YTGpadcKey s_button2(/*KEY_B3*//*KEY_B1*/KEY_B0);// long (model)short (next/pause)	 ----->ƒ£ Ω+…œœ¬ ◊/¥Ú∂œ			

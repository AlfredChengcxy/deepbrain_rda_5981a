...
#elif KMT_PCBA
static duer::YTGpadcKey s_button4(KEY_B5);// long (wechat)			short (play wechat)			4∫≈º¸
static duer::YTGpadcKey s_button3(KEY_B4);// long (action) 		short (volume ctl)    			3∫≈º¸
static duer::YTGpadcKey s_button2(KEY_B3);// long (model)			short (next/pause)				2∫≈º¸
static duer::YTGpadcKey s_button1(KEY_B0);// long (awake)			short (net)					1∫≈º¸
#endif
